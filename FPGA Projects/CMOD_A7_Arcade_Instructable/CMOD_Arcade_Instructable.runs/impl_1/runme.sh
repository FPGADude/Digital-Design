...
HD_PWD='C:/Users/david/FPGA_Vivado_Designs/CMOD_Arcade_Instructable/CMOD_Arcade_Instructable.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_arcade_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oled_arcade_top.tcl -notrace
